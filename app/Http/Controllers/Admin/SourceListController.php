...
class SourceListController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('admin.sourcelists.index', compact('sourcelists'));
    }
    ...
    {
        return view('admin.sourcelists.create');
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('sourcelists.index')->with('success', 'Источник добавлен');
    }
    ...
    {
        return view('admin.sourcelists.edit', compact('sourcelist'));
    }
    ...
    public function update(Request $request, SourceList $sourcelist)
    {
        ...
        return redirect()->route('sourcelists.index')->with('success', 'Источник обновлён');
    }
    ...
    {
        $sourcelist->delete();
        return redirect()->route('sourcelists.index')->with('success', 'Источник удалён');
    }
}
