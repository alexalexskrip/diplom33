        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    ...
                    <a href="{{ route('faculties.create') }}" class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded mb-4 inline-block">
                        Добавить факультет
                    </a>
                            ...
                            @forelse($faculties as $faculty)
                                <tr class="hover:bg-gray-50">
                                    ...
                                    <td class="py-3 px-4 flex space-x-2 justify-center">
                                        <a href="{{ route('faculties.edit', $faculty->id) }}" class="inline-flex items-center px-3 py-1 bg-blue-500 text-white rounded hover:bg-blue-600 transition">
