        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    <form action="{{ route('networklists.update', $networklist->id) }}" method="POST">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="mt-6 flex justify-start space-x-4">
                            ...
                            <a href="{{ route('networklists.index') }}" class="bg-gray-500 hover:bg-gray-700 text-white font-bold py-2 px-4 rounded">Отмена</a>
                        </div>
                    </form>
                </div>
            </div>
