        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    <form action="{{ route('cabinet.sourcelists.update', $sourcelist->id) }}" method="POST">
                        @csrf
                        @method('PUT')

                        <div class="mb-6">
                            <label for="name_sourcelist" class="block text-sm font-medium text-gray-700">Название</label>
                            <input type="text" name="name_sourcelist" id="name_sourcelist" value="{{ old('name_sourcelist', $sourcelist->name_sourcelist) }}" required class="mt-1 block w-full rounded-md border-gray-300 shadow-sm">
